...
export const GridBackground = () => {
  ...
  const draw = () => {
    ...
    // Draw main grid with steel grey
    ctx.strokeStyle = 'rgba(107, 140, 174, 0.15)' // accentBlue with low opacity for grid
    ctx.lineWidth = 1
    const gridSize = 60
    ...
    gradient.addColorStop(0.5, 'rgba(0, 212, 170, 0.25)') // accentCyan with glow
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      ctx.fillStyle = 'rgba(0, 212, 170, 0.2)' // accentCyan particles
      ctx.fill()
    }
